"use strict";if($(".main-body .page-wrapper").find("#item-details-container").length){function a(a){var b=token,c=reviewUrl+"?page="+a,d=itemId;return $.ajax({url:c,method:"POST",data:{_token:b,page:a,product_id:d},success:function(a){$("#load_review").html(a),$("span span.text-gray-500").css("background","#eee")}}),1}function b(){for(var a,b=document.getElementById("image"),c=0;c<b.files.length;c++){if(a=b.files[c],!allowExtension.includes(a.name.split(".").pop()))return!1;if(2048e3<a.size)return 2}return!0}function c(){let a,b=!0,c=attributePriceWithId.replace(/[\r\n]+/g,"");a=JSON.parse(c),$.each(a,function(a,c){if(o(c.attributeIds)){b=!1,selectedIds=[],$("#availability").addClass("display-none"),$("#item_price").removeClass("display-none"),$("#item_price").text(decimalNumberFormatWithMultiCurrency(c.price)),$(".product-view-summary .main-summary").addClass("display-none"),$(".product-view-summary .variation").removeClass("display-none").html(c.description),$("#varMinMaxPrice").addClass("display-none"),variationId=c.variation_id,variationStatus=c.stock_status,variationAttributeIds=c.attributeIds,backOrders=c.backOrders,"sale"==c.priceType?(discountInPercent=c.discountInPercent,offerFlag=!0):offerFlag=!1,outOfStockVisible=c.isOutOfStock.outOfStockVisibility,m(c.images),"1"==c.is_enable_b2b?($("#b2b_table").html(""),d(c.b2b_data)):$("#b2b_table").html("");let a="",f="";if(""!=c.weight&&(a=`<tr id="weightRow">
                    ...
                    `,$("#dimensionsRow").replaceWith(f)),c.is_show_stock_status)if($("#stock_qty").removeClass("display-none"),"In Stock"!=c.stock_status)$("#stock_qty").html("<span class=\"text-reds-3 leading-4 bg-pinks-2 px-4 py-2 text-sm roboto-medium font-medium rounded capitalize\">"+jsLang("Out Of Stock")+"</span>");else if($("#stock_qty").html("<span class='text-green-1 capitalize leading-4 bg-green-2 px-4 py-2 text-sm roboto-medium font-medium rounded mr-2.5 rtl-direction-space-left'>"+jsLang("In Stock")+"</span>"),c.is_show_stock_quantity){var e=jsLang(":x items remaining");e=e.replace(":x",c.stock_quantity),$("#stock_qty").append(e)}return"sale"==c.priceType?($("#item_offer_price").text(decimalNumberFormatWithMultiCurrency(c.regular)),$("#item_offer_price").removeClass("display-none"),q(c.saleTo,!0)):($("#item_offer_price").addClass("display-none"),$("#countDown").addClass("display-none")),!1}}),!0==b&&(variationId=null,variationAttributeIds=[],outOfStockVisible=0,$("#item_offer_price").addClass("display-none"),$("#item_price").addClass("display-none"),$("#stock_qty").addClass("display-none"),$("#varMinMaxPrice").removeClass("display-none"),!0==f()?$("#availability").removeClass("display-none"):"",m(null,"default"),$(".product-view-summary .main-summary").removeClass("display-none"),$(".product-view-summary .variation").addClass("display-none"))}function d(a){let b=``;$.each(a,function(a,c){c.min_qty&&c.max_qty&&c.price&&(b+=`<tr class="py-4 px-6 border b2b_table">
