...
class MenuItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        MenuItems::where('link', 'order-setting')->update(['params' => '{"permission":"App\\\\Http\\\\Controllers\\\\OrderSettingController@index","route_name":["order.setting.option", "orderStatues.index", "invoice.setting.option"]}']);
