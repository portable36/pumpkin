...
@section('content')
    <!-- Main content -->
    <div class="list-container" id="delivery-withdrawal-container">

        <div class="card">
            <div class="card-header d-md-flex justify-content-between align-items-center">
                <h5>{{ __('Withdrawals History') }}</h5>
                <div class="mt-md-0 mt-2">
                    <a href="{{ route('carrier.withdrawal_setting') }}" class="btn btn-outline-primary mb-0 custom-btn-small">
                        <span class="fa fa-cog" aria-hidden="true">&nbsp;</span>
                        <span>{{ __('Setting') }}</span>
                    </a>
                    <a href="{{ route('carrier.withdrawal_money') }}" class="btn btn-outline-primary mb-0 me-0 custom-btn-small">
