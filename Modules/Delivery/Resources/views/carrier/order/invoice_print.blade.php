                    ...
                    <tbody>
                        @foreach ($orderDetails as $detail)
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    <p class="product-details">{{ $detail->unit ?? $unit->abbr }}</p>
                                </td>
                                @if ($shop)
                                    <td class="td">
                ...
                <table class="table">
                    ...
                    @endphp
                        ...
                        <tr>
                            ...
                            <td class="footer-information">{{ formatNumber($order->tax_charge, $currency) }}
                            </td>
                        </tr>
                        @if ($couponOffer > 0)
                            <tr>
                                ...
                                <td class="footer-information">{{ formatNumber($couponOffer, $currency) }}
                                </td>
                            </tr>
                        @endif
                        @if ($order->other_discount_amount > 0)
                            <tr>
                                ...
                                <td class="footer-information">{{ formatNumber($order->other_discount_amount, $currency) }}
                                </td>
                            </tr>
                        @endif
                        <tr>
