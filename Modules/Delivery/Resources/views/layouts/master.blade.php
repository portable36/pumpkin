...
<head>
    @doAction("after_delivery_panel_head")
    ...
    @doAction("before_delivey_panel_css_{$view_name}")

    @yield('parent-css')

    @doAction("after_delivery_panel_css_{$view_name}")
...
<body <?php echo apply_filters('delivery_panel_body_tag', ''); ?>>
    @doAction("after_delivery_panel_body")
    <!-- [ Pre-loader ] start -->
    <div class="loader-bg">
    ...
    @doAction("before_delivery_panel_sidebar")
    @include('delivery::includes.sidebar')
    @doAction("after_delivery_panel_sidebar")
    <!-- [ navigation menu ] end -->

    <!-- [ Header ] start -->
    @doAction("before_delivery_panel_header")
    @include('delivery::includes.header')
    @doAction("after_delivery_panel_header")
    <!-- [ Header ] end -->
        ...
        <div class="pcoded-wrapper">
            <div class="pcoded-content">
                <div class="pcoded-inner-content">
                    <!-- [ breadcrumb ] start -->
                    @include('delivery::includes.notifications')
                    <!-- [ breadcrumb ] end -->
                    <div class="main-body">
                        <div class="page-wrapper">
                            <!-- [ Main Content ] start -->
                            @doAction("before_delivery_panel_content")
                            @doAction("before_delivery_panel_content_{$view_name}")
                            <div class="row">
                                <div class="col-sm-12 list-container">
                                    @yield('parent-content')
                                </div>
                            </div>
                            @doAction("after_delivery_panel_content")
                            @doAction("after_delivery_panel_content_{$view_name}")
                            <!-- [ Main Content ] end -->
                        </div>
                    </div>
                </div>
