                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div data-toggle="modal" data-target="#exampleModalCenter" class="custom-file" data-val="single" id="image-status" data-type="png,jpg,jpeg,webp">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control select2-hide-search" id="button_animation"
                                            ...
                                            @foreach ($animations as $key => $animation)
                                                <option value="{{ $key }}" {{ $key == $slide->button_animation ? 'selected' : '' }}>{{ $animation }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <select class="form-control select2-hide-search" id="title_animation" name="title_animation">
                                            @foreach ($animations as $key => $animation)
                                            <option value="{{ $key }}" {{ $key == $slide->title_animation ? 'selected' : '' }}>{{ $animation }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <select class="form-control select2-hide-search" id="sub_title_animation" name="sub_title_animation">
                                            @foreach ($animations as $key => $animation)
                                            <option value="{{ $key }}" {{ $key == $slide->sub_title_animation ? 'selected' : '' }}>{{ $animation }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <select class="form-control select2-hide-search" id="description_title_animation" name="description_title_animation">
                                            @foreach ($animations as $key => $animation)
                                            <option value="{{ $key }}" {{ $key == $slide->description_title_animation ? 'selected' : '' }}>{{ $animation }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
