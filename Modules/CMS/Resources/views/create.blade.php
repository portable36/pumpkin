...
@section('content')
    ...
    <div class="col-sm-12 page-create" id="page-container">
        <div class="card">
            ...
            <div class="card-body p-0" id="no_shadow_on_card">
                <div class="col-sm-12 m-t-20 form-tabs">
                    ...
                    <form action='{{ route('page.store', ['lang' => request()->input('lang', 'en')]) }}' method="post" class="form-horizontal" id="userEdit"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <div data-toggle="modal" data-target="#exampleModalCenter"
                                                    class="custom-file" data-val="single" id="image-status" data-type="png,jpg,jpeg,webp">
...
@section('js')
    <script>
        const langUrl = '{{ route('page.home.create') }}';
    </script>
