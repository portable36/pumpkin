...
class VendorCouponDataTable extends DataTable
{
    ...
    */
    ...
    {
        $coupons = Coupon::select('id', 'name', 'code', 'discount_type', 'discount_amount', 'start_date', 'end_date', 'status')->where('vendor_id', session()->get('vendorId') ?? auth()->user()?->vendor()?->vendor_id ?? null);
