...
class StockManagement extends Model
{
    ...
    public static function productStockOrder($locationId, $product, $adjust, $isDecrease = true)
    {
        ...
        if ($request->filled(['customLocation', 'locationId'])) {
            $locationId = $request->locationId;
        }

        if ($request->meta_order_type === 'pos' && $request->filled('meta_location_id')) {
            $locationId = $request->meta_location_id;
        }
