...
use Modules\Inventory\Http\Requests\AdminLocationStoreRequest;
...
class LocationController extends Controller
{
     ...
     * @return Renderable
     */
    public function store(AdminLocationStoreRequest $request)
    {
     ...
     * @return Renderable
     */
    public function update(AdminLocationStoreRequest $request, $id)
    {
