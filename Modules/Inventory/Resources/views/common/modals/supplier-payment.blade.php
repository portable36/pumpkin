...
@endphp
<div id="supplier_payment" class="modal fade display_none" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <form action="{{ $paymentRoute }}" method="get" id="supplier_payment_form">
                <div class="modal-header">
                    <h4 class="modal-title">{{ __('Payment for supplier') }}</h4>
