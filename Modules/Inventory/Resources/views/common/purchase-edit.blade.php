<div class="col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" readonly="true">
                                    <option value="{{ $purchaseDetails->vendor_id }}" selected>{{ $purchaseDetails->vendor?->name ?? __('Unknown') }}</option>
                                </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" readonly="true" name="supplier_id" id="supplier_id" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                <option value="{{ $purchaseDetails->supplier_id }}" selected>{{ optional($purchaseDetails->supplier)->name . ' (' . optional($purchaseDetails->supplier)->email . ')'  }}</option>
                            </select>
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label require">{{ __('Purchase Date') }}</label>
                        <div class="col-md-8">
                            <input id="purchase_date" class="form-control inputFieldDesign" type="text" name="purchase_date" value="{{ $purchaseDetails->purchase_date }}" >
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control select2 shipping-provider-ajax" name="shipping_carrier" id="shipping_carrier">
                                <option value="{{ $purchaseDetails?->shipping_carrier }}">{{ $shippingProviders->where('slug', $purchaseDetails?->shipping_carrier)->first()?->name  }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <table class="table" id="product-table">
                        ...
                        <tr class="itemRow rowNo-{{ $key }}" id="productId-{{ $detail->product_id }}"  data-row-no="{{ $key }}">
                            ...
                            <td>
                                <input type="hidden" name="product_unit[]" value="{{ $detail->unit ?? defaultUnit()?->abbr }}">
    ...
    <div class="col-sm-10 px-0 mt-3 mt-md-0">
        <a href="{{ isset($userType) && $userType == 'admin' ? route('purchase.index') : route('vendor.purchase.index') }}"
