            ...
            <div class="row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control select2 sl_common_bx" name="currency_id" id="currency_id" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                ...
                                @foreach($currencies as $currency)
                                    <option value="{{ $currency->id }}" {{ $currency->id == preference('dflt_currency_id') ? 'selected' : '' }} >{{ $currency->name  }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="purchase_date" class="form-control inputFieldDesign" type="text" name="purchase_date">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control select2 sl_common_bx shipping-provider-ajax" name="shipping_carrier" id="shipping_carrier">
                                <option value="">{{ __('Select One')  }}</option>
                            </select>
                        </div>
                    </div>
