...
<body>
    @php
        // $code get from from controller
        $order = App\Models\Order::where('reference', $code)->first();
        $purchaseData = Modules\Gateway\Entities\PaymentLog::where('code', $order->id)->orderBy('id', 'desc')->first();
    @endphp
