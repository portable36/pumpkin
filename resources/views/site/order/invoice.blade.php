                ...
                <table class="table">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td">
                                    <p class="product-details currency_symbol">
                                        {{ formatNumber($detail->price * $detail->quantity, $currency) }}
                                    </p>
                                </td>
                            </tr>
                        @endforeach
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="footer-information">{{ __('Sub Total') }} :</td>
                            @php
                                $couponOffer = isset($order->couponRedeems) && $order->couponRedeems->sum('discount_amount') > 0 && isActive('Coupon') ? $order->couponRedeems->sum('discount_amount') : 0;
                            @endphp
                            <td class="footer-information currency_symbol">
                                {{ formatNumber($order->total + $order->other_discount_amount + $couponOffer - ($order->shipping_charge + $order->tax_charge), $currency) }}
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="td"> </td>
                            <td colspan="2" class="footer-information">
                        ...
                        <tr>
                            <td colspan="2" class="td"> </td>
                            <td colspan="2" class="footer-information">{{ __('Tax') }} :</td>
                            
                            <td class="footer-information currency_symbol">{{ formatNumber($order->tax_charge + $customFee['customTaxTotal'] + $customTax, $currency) }}
                            </td>
                        </tr>
                        @if((isset($customFee['feeTotal']) && $customFee['feeTotal']) > 0)
                        <tr>
                            <td colspan="2" class="td"> </td>
                            <td colspan="2" class="footer-information">{{ __('Fees') }} :</td>
                            
                            <td class="footer-information currency_symbol">{{ formatNumber($customFee['feeTotal'], $currency) }}
                            </td>
                        </tr>
                        @endif
                        @if ($couponOffer > 0)
                            <tr>
                                <td colspan="2" class="td"> </td>
                                <td colspan="2" class="footer-information">{{ __('Coupon offer') }} :</td>
                                
                                <td class="footer-information currency_symbol">-{{ formatNumber($couponOffer, $currency) }}
                                </td>
                            </tr>
                        @endif
                        @if ($order->other_discount_amount > 0)
                            <tr>
                                <td colspan="2" class="td"> </td>
                                <td colspan="2" class="footer-information">{{ __('Discount') }} :</td>
                                
                                <td class="footer-information currency_symbol">{{ formatNumber($order->other_discount_amount, $currency) }}
                                </td>
                            </tr>
                        @endif
                        <tr>
                            <td colspan="2" class="td"> </td>
                            <td colspan="2" class="footer-information border-top">{{ __('Total') }} :</td>
