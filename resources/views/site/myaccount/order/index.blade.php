...
@section('content')
    @php
        $orders = Auth::user()->orders()->where('channel', 'web')->orderBy('order_date', 'desc')->filter();
                    ...
                    <tbody>
                        @if ($orders->count())
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-4">
                                    <span class="font-medium text-sm text-black whitespace-nowrap">
                                        {{ formatNumber($order->total + \App\Services\Order\InvoiceService::totalCustomAmount($order)) }}
                                    </span>
                                </td>
                                <td class="px-3 py-4 ltr:text-left rtl:text-right">
