        ...
        <div id="item-details-section" class="flex flex-wrap mt-6">
            <div class="w-full lg:w-72% ltr:lg:pr-3 rtl:lg:pl-3">
                ...
                @if (count($product->getRelatedProductIds()))
                    <div id="related_products" data-productId="{{ $product->id }}">
                ...
                @if (count($product->getUpSaleIds()))
                    <div id="upsale_products" data-productId="{{ $product->id }}">
                        <div class="mt-12">
            ...
            <div class="w-full lg:w-28% md:mt-4 ltr:lg:pl-3 rtl:lg:pr-3">
                ...
                @if (!empty($vendorDetails))
                    ...
                    <div id="same_shop" data-productId="{{ $product->id }}">
                        <div class="mt-15p md:mt-30p">
...
@section('js')
    ...
    <script src="{{ asset('public/dist/js/custom/site/product-details.min.js?v=4.2') }}"></script>
