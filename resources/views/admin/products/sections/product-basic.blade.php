                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" placeholder="{{ __('Name') }}"
                                                    ...
                                                    value="{{ isset($product) ? $product->getTranslated('name', request()->input('lang', config('app.locale'))) : '' }}">
                                                <div
                                                    class="align-items-center mt-12p  {{ !isActive('SaaS') ? 'permalink-section close-parent' : '' }}  {!! isset($product) && !isActive('SaaS') ? ' d-md-flex flex-wrap ' : 'd-none' !!}">
                                                    <span class="color-2c">{{ __('Permalink') }}:</span>
                                                    <a class="m-change ltr:ms-1 rtl:me-1 preview-link word-break" target="_blank"
                                                        href="{{ isset($product) ? route('site.productDetails', ['slug' => $product->getTranslated('slug', request()->input('lang', config('app.locale')))]) : '' }}"
                                                    ...
                                                    <input
                                                        ...
                                                        type="text" disabled
                                                        value="{{ isset($product) ? $product->getTranslated('slug', request()->input('lang', config('app.locale'))) : '' }}" />
                                                    <a
