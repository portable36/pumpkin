    ...
    <div id="additional_info" class="mini-form-holder form-group row px-7 mb-0 collapse show">
        <div class="col-md-12">
            <div class="mx-8p">
                ...
                <select class="form-control select2clearable product_brand_id" name="brand_id">
        ...
        <div class="col-md-12">
            <div class="mx-8p">
                ...
                <select class="form-control select2clearable sl_common_bx vendor-ajax" name="vendor_id" id="vendor_id">
                    ...
                    @else
                        @if (isset($product))
                            <option value="{{ $product->vendor_id }}" selected>{{ $vendors->where('id', $product->vendor_id)->first()?->name }}</option>
                        @endif
                    @endif
                </select>
                @if(isActive('Disablemultivendor') && preference('is_active_single_vendor') == 1 && !isset(auth()->user()->vendor()->vendor_id))
