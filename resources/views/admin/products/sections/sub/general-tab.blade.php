<div class="mini-form-holder tab-pane fade {{ isset($product) && ($product->isGroupedProduct() || $product->isVariableProduct()) ? '' : 'show active' }} pb-3"
    ...
    <div class="form-group row px-2 mt-4">
        ...
        <div class="col-md-7 p-0-res">
            <div class="row">
                <div class="col-md-3">
                    <label for="price" class="sp-title control-label">{{ __('Unit') }}</label>
                </div>
                <div class="col-md-6">
                    <select name="meta_unit" class="select2 w-100">
                        @foreach ($units as $unit)
                            <option @selected(
                                (isset($product) && $product?->unit == $unit->abbr) ||
                                (!isset($product) && $unit->default == 'Yes')
                            )
