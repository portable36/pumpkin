<div class="tab-pane fade mini-form-holder {{ isset($product) && ($product->isGroupedProduct()) ? 'show active' : '' }}"
                ...
                <div class="col-md-8">
                    <div class="checkbox checkbox-primary d-inline w-space">
                        ...
                        <input class="c-click {{ isset($product) && $product->manage_stocks ? '' : 'collapsed' }} {{ isActive('Inventory') ? 'has_impact' : '' }}"
                            data-bs-toggle="collapse" href="javascript:void(0)" type="checkbox"
    ...
    <div
        class="form-group row px-2 s-hide conditional-dom not-external-dom not-grouped-dom global-stock-status {{ isset($product) && ($product->manage_stocks || $product->isExternalProduct() || $product->isGroupedProduct()) ? 'd-none' : '' }}">
    ...
    <div
        class="{{ isActive('SaaS') ? 'display-none' : '' }} form-group row px-2 mt-4 conditional-dom not-external-dom not-grouped-dom {{ isset($product) && ($product->isExternalProduct() || $product->isGroupedProduct()) ? 'd-none' : '' }}">
        <div class="col-md-5 p-0-res">
            <div class="row d-flex align-items-center">
                <div class="col-md-4">
