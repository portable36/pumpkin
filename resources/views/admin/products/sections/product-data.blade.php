<div class="card option-value-rowid ui-sortable-handle transition-none impact_parent common_c">
    <div class="mini-form-holder d-flex d-flx-n align-items-center pr-30p relative">
        <div
            class="{{ isActive('SaaS') ? 'display-none' : '' }} mr-42p mr-19-res mt-10-res div_h virtual-child conditional-dom not-variable-dom not-grouped-dom not-external-dom {{ isset($product) && $product->isSimpleProduct() ? '' : 'd-none' }}">
        ...
        <div
            class="{{ isActive('SaaS') ? 'display-none' : '' }} mr-42p div_h download-child conditional-dom not-variable-dom not-grouped-dom not-external-dom {{ isset($product) && $product->isSimpleProduct() ? '' : 'd-none' }}">
