<ul class="nav nav-pills" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link h-lightblue ltr:pe-2 rtl:ps-2 {{ Route::currentRouteName() == 'users.ledger' ? 'active' : '' }}" href="{{ route('users.ledger', ['id' => $user->id ?? request()->user_id]) }}" role="tab" aria-controls="mcap-default" aria-selected="true">{{ __('Ledger') }}</a>
    </li>
    <li class="nav-item">
