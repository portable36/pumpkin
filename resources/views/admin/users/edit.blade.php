            ...
            <div class="card-body p-0" id="no_shadow_on_card">
                ...
                <div class="col-sm-12 form-tabs px-3">
                    <ul class="nav nav-tabs " id="myTab" role="tablist">
                        ...
                        @hasPermission('App\Http\Controllers\UserController@updatePassword')
                            <li class="nav-item">
                                                ...
                                                <select class="form-control select2-hide-search inputFieldDesign"
                                                    ...
                                                    @foreach ($roles as $key => $role)
                                                        <option value="{{ $role->id }}"
                                                            {{ in_array($role->id, $roleIds) ? 'selected' : ( !is_null($user->role()->vendor_id) && $role->id == vendorStaffRole() ? 'selected' : ''  ) }}>
                                                            {{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                ...
                                                <div id="img-container">
                                                    <div class="d-flex flex-wrap mt-2">
                                                        <div
                                                            ...
                                                            <img class="upl-img object-fit-contain p-1"
                                                                src="{{ $user->fileUrl() }}" alt="{{ __('Image') }}">
                                                        </div>
                                                    </div>
                                                </div>
...
@php
    ...
    $vendorStaffRole = vendorStaffRole();
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var vendorListUrl = "{!! route('users.vendor.list') !!}";
