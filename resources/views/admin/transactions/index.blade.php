...
<div class="col-sm-12 list-container" id="transaction-list-container">
    <div class="card">
        <div class="card-header bb-none pb-0">
            ...
            <x-backend.group-filters :column="'status'" :table="'transactions'" :groupClass="'need-ajax-status'" />
        ...
        <x-backend.datatable.filter-panel>
            ...
            <div class="col-md-2">
                <select class="select2 user-ajax filter filter-drop-down" name="user_id">
                    {{-- Data will be loaded using ajax --}}
                </select>
            </div>
            
            <div class="col-md-2">
                <select class="select2 vendor-ajax filter filter-drop-down" name="vendor_id">
                    {{-- Data will be loaded using ajax --}}
                </select>
            </div>
        </x-backend.datatable.filter-panel>
