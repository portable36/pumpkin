        ...
        <div class="card">
            <div class="card-header justify-content-between align-items-center">
                ...
                <div class="d-md-flex justify-content-end align-items-center margin-top-neg-30">
                    <div>
                        <button class="btn btn-outline-primary mb-0 custom-btn-small root-category">{{ __('New :x', ['x' => __('Root Category')]) }}</button>
                    </div>
                    
                    <div>
                        <button class="btn btn-outline-primary mb-0 ltr:me-0 rtl:ms-0 custom-btn-small sub-category">{{ __('New :x', ['x' => __('Sub Category')]) }}</button>
                    </div>
                    &nbsp;&nbsp;&nbsp;
                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5" id="formBlock">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="custom-file position-relative" data-val="single" data-type="png,jpg,jpeg"
                                                    id="image-status">
...
@section('js')
    ...
    <script>
        var currentCategoryUrl = '{{ route('categories.index') }}';
        var selectedLang = '{{ request()->input('lang', config('app.locale')) }}';
        var isAllowSuggestion = 0;
    </script>
