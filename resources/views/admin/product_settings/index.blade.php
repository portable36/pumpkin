                                                ...
                                                <div class="form-tabs">
                                                    <div class="tab-content box-shadow-unset px-0 py-2">
                                                        <div class="tab-pane fade show active" id="home"
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="vendor_brand"
                                                                    class="col-sm-3 control-label">{{ __('Custom Brand') }}</label>
                                                                <div class="col-9 d-flex">
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        <input type="hidden" name="vendor_brand"
                                                                            value="0">
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="vendor_brand"
                                                                                class="checkActivity" id="vendor_brand"
                                                                                value="1"
                                                                                {{ preference('vendor_brand', '') == 1 ? 'checked' : '' }}>
                                                                            <label for="vendor_brand" class="cr"></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mt-2">
                                                                        <span>{{ __('Enabling this option, the vendor can create their own brand from vendor panel.') }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="vendor_attribute"
                                                                    class="col-sm-3 control-label">{{ __('Custom Attribute') }}</label>
                                                                <div class="col-9 d-flex">
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        <input type="hidden" name="vendor_attribute"
                                                                            value="0">
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="vendor_attribute"
                                                                                class="checkActivity" id="vendor_attribute"
                                                                                value="1"
                                                                                {{ preference('vendor_attribute', '') == 1 ? 'checked' : '' }}>
                                                                            <label for="vendor_attribute" class="cr"></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mt-2">
                                                                        <span>{{ __('Enabling this option, the vendor can create their own attribute from vendor panel.') }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @endif
