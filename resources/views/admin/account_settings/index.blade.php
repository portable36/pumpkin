                        ...
                        <div class="card-block table-border-style">
                            <form action="{{ route('account.setting.option') }}" method="post" class="form-horizontal"
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-4 control-label"
                                               for="otp_expire_in">{{ __('OTP Expiration Time') }}</label>
                                        <div class="col-6">
                                            <input type="number" name="otp_expire_in" class="form-control inputFieldDesign" 
                                                   value="{{ preference('otp_expire_in', 5) }}" min="1" max="60" step="1">
                                        </div>
                                        <div class="offset-4 col-8">
                                            <small class="text-muted">{{ __('OTP will be valid for the specified number of minutes. Default is 5 minutes.') }}</small>
                                        </div>
                                    </div>
