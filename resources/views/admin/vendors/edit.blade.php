                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-9 mt-2">
                        ...
                        <div class="form-group row conditional preview-parent">
                            ...
                            <div class="col-sm-9">
                                <div class="custom-file position-relative position-relative media-manager-img" data-val="single" data-type="png,jpg,jpeg,webp"
                        ...
                        <div class="form-group row conditional preview-parent">
                            ...
                            <div class="col-sm-9">
                                <div class="custom-file position-relative media-manager-img" data-val="single" data-type="png,jpg,jpeg,webp"
                                    data-returntype="ids" id="image-status">
                                    <input class="custom-file-input is-image form-control inputFieldDesign"
...
@section('js')
    ...
    <script src="{{ asset('public/dist/js/custom/vendors.min.js?v=3.3') }}"></script>
