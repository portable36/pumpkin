                    ...
                    <div class="lg:ml-23p ml-21p mt-2.5 lg:mt-18p">
                      ...
                      <span class="relative ml-2p md:ml-0">
                        ...
                        <div class="md:w-300p border-l md:-ml-2 -ml-1.5 border-dashed border-gray-27">
                            <p class="break-words text-gray-12 dm-sans md:mb-28 mb-10 md:-mt-1.5 -mt-1 md:pl-23p pl-21p font-medium lg:text-xl lg:w-full leading-30px leading-21px leading-17px xs:text-sm text-xs ">@yield('message')</p>
                        </div>
                       </div>
