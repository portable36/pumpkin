    ...
    <div id="vendor-item-list-container">
        <div class="card">
            ...
            <x-backend.datatable.filter-panel class="mx-1">
                ...
                <div class="col-md-2">
                    <select class="select2 brand-ajax filter" name="brand">
                ...
                <div class="col-md-2">
                    <select class="select2 category-ajax filter" name="category">
                        {{-- <option value="">{{ __('All Categories') }}</option>
                        @foreach ($productCategories as $category)
                            <option value="{{ $category->id }}">{{ checkJsonValidation($category->name) }}</option>
                        @endforeach --}}
                    </select>
                </div>
                <div class="col-md-2">
