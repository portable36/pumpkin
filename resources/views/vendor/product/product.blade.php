...
@section('content')
    ...
    <form
        action="{{ isset($product) ? route('vendor.product.edit-action', ['code' => $product->code, 'lang' => request()->input('lang', config('app.locale'))]) : route('vendor.product.create', ['lang' => request()->input('lang', config('app.locale'))]) }}"
...
@section('js')
    ...
    <script src="{{ asset('public/dist/js/custom/custom-category.js') }}"></script>
    <script>
    ...
    <script>
        let itemUrl =
            '{{ isset($product) ? route('vendor.product.edit-action', ['code' => $product->code, 'lang' => request()->input('lang', config('app.locale'))]) : route('vendor.product.create', ['lang' => request()->input('lang', config('app.locale'))]) }}';
        let itemsAjaxSearch =
        ...
        var isActiveSaaS = '{{ isActive('SaaS') }}';
    </script>
    <script src="{{ asset('public/dist/js/xss.min.js') }}"></script>
    <script src="{{ asset('public/dist/js/custom/create-product.min.js?v=5.1.0') }}"></script>
