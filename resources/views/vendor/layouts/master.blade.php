...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/dist/css/custom.min.css?v=3.3') }}">
    ...
    <script type="text/javascript">
        ...
        var defaultCountryCode = '{{ preference('company_country') }}';
    </script>
...
<body <?php echo apply_filters('vendor_panel_body_tag', ''); ?>>
    ...
    <script src="{{ asset('public/dist/js/custom/app-layout.min.js?v=3.3') }}"></script>
