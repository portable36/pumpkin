    ...
    <div class="col-sm-12" id="attribute-add-container">
        <div class="card">
            <div class="card-header">
                <h5> <a href="{{ route('vendor.attribute.index') }}">{{ __('Attributes') }} </a> >>{{ __('Create :x', ['x' => __('Attribute')]) }}</h5>
            </div>
            <div class="card-block table-border-style">
                <div class="row form-tabs">
                    <form action="{{ route('vendor.attribute.store') }}" method="post" id="attributeForm" class="form-horizontal col-sm-12" enctype="multipart/form-data" onsubmit="#">
                        @csrf
                                        ...
                                        <div class="tab-pane fade show active" id="attribute" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <label for="has_attribute" class="control-label display_none" id="has_attribute"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="Type" class="control-label ltr:ps-3 rtl:pe-3">{{ __('Appearance Type') }}</label>
                                                <div class="col-sm-12">
                        ...
                        <div class="col-sm-10 ltr:ps-1 rtl:pe-1 m-l-35">
                            <a href="{{ route('vendor.attribute.index') }}" class="btn custom-btn-cancel all-cancel-btn">{{ __('Cancel') }}</a>
