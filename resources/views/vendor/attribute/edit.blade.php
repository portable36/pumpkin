    ...
    <div class="col-sm-12" id="attribute-edit-container">
        <div class="card">
            <div class="card-header">
                <h5> <a href="{{ route('vendor.attribute.index') }}">{{ __('Attributes') }} </a> >>{{ __('Edit :x', ['x' => __('Attribute')]) }}</h5>
            </div>
            <div class="card-block table-border-style">
                <div class="row form-tabs">
                    <form action="{{ route('vendor.attribute.update', $attributes->id) }}" method="post" id="attributeForm" class="form-horizontal col-sm-12" enctype="multipart/form-data">
                        @csrf
