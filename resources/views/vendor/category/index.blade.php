    ...
    <div class="col-sm-12" id="category-info-container">
        <div class="card">
            <div class="card-header justify-content-between align-items-center">
                <h5> <a href="{{ route('vendor.categories.index') }}">{{ __('Categories') }} </a> </h5>
                <div class="d-md-flex justify-content-end align-items-center margin-top-neg-30">
                    <div>
                        <button
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <div class="col-md-2">
                        <select class="form-control select2 clearable mb-0 p-0" name="category_language_id" id="category_language_id">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5" id="formBlock">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" placeholder="{{ __('Name') }}" class="form-control form-width inputFieldDesign" id="name" name="name" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')" data-related="slug" value="{{ old('name') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="custom-file position-relative" data-val="single" data-type="png,jpg,jpeg,webp"
                                                     id="image-status">
...
@section('js')
    ...
    <script>
        var currentCategoryUrl = '{{ route('vendor.categories.index') }}';
        var selectedLang = '{{ request()->input('lang', config('app.locale')) }}';
        const vendorId = '{{ $vendorId }}';
    </script>
    <script src="{{ asset('public/dist/js/custom/category.min.js?v=4.1') }}"></script>
@endsection
