        ...
        <div class="card">
            ...
            <div class="card-block table-border-style">
                <div class="row form-tabs">
                    <form action="{{ route('vendor.brands.update', $brands->id) }}" method="post" id="brandAdd"
                                            ...
                                            <div class="col-md-9">
                                                <div class="fixSize user-img-con">
                                                    <a class="cursor_pointer" href='{{ $brands->fileUrl() }}'
                                                        ...
                                                        <img class="profile-user-img img-responsive fixSize rounded-circle" src='{{ $brands->fileUrl() }}' alt="{{ __('Image') }}" class="img-thumbnail img-fluid attachment-styles">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
