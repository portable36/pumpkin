    ...
    <div class="list-container" id="vendor-transaction-container">
        ...
        <div class="card">
            <div class="card-header bb-none pb-0">
                ...
                @endphp
                <x-backend.group-filters :groups="$groups" :column="'status'" :table="'transactions'" :groupClass="'need-ajax-status'" :vendorId="$vendorId" />
            ...
            <x-backend.datatable.filter-panel class="mx-1">
                ...
                @if (isset($users))
                    <div class="col-md-3">
                        <select class="user-ajax filter filter-drop-down" name="user_id">
