...
@section('page_title', __('Update :x', ['x' => __('Customer')]))
@section('css')
        ...
        <div class="card">
            <div class="card-header">
                <h5> <a href="{{ route('vendor.customer') }}">{{ __('Customer') }} </a>
                    >> {{ __('Update :x', ['x' => __('Customer')]) }}</h5>
            </div>
            <div class="card-block table-border-style">
                @include('common.customer.top-menu', ['customer' => $customer, 'from' => 'vendor', 'menuName' => 'profile'])
                <div class="row form-tabs">
                    <form action="{{ route('vendor.customer.update', $customer->id) }}" method="post" id="userAdd"
                        ...
                        <div class="col-sm-12 tab-content form-edit-con" id="myTabContent">
                            <div class="tab-pane fade show active form-con" id="home" role="tabpanel"
                                ...
                                @include('common.customer.edit', ['panel' => 'vendor'])
