    ...
    <div class="col-sm-12 list-container" id="attribute_group-list-container">
        <div class="card">
            <div class="card-header d-md-flex justify-content-between align-items-center">
                ...
                @hasPermission('App\Http\Controllers\AttributeGroupController@create')
...
@section('js')
    ...
    <script type="text/javascript">
        'use strict';
        var pdf = "{{ (auth()->user()?->hasPermission('App\Http\Controllers\AttributeGroupController@pdf')) ? '1' : '0' }}";
        var csv = "{{ (auth()->user()?->hasPermission('App\Http\Controllers\AttributeGroupController@csv')) ? '1' : '0' }}";
    </script>
