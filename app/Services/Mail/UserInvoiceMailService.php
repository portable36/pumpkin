...
class UserInvoiceMailService extends TechVillageMail
{
    ...
    protected function sendEmailUser($request, $isSpecificMail = false)
    {
        ...
        $customTax = $request->updatedCustomTaxFee($request, true);
        ...
        $data = [
            ...
            '{grand_total}' => formatCurrencyAmount($request->total + $customTax + $customFee['feeTotal'] + $customFee['customTaxTotal']),
            ...
            '{tax_charge}' => formatCurrencyAmount($request->tax_charge + $customFee['customTaxTotal'] + $customTax),
