...
class Attribute extends Model
{
    ...
    protected static function storeValidation($data = [])
    {
        $rules = [
            ...
            'type' => 'required|in:dropdown,color',
            'additional_values' => 'required_if:type,color|array',
        ...
        $message = [
            ...
            'additional_values.required_if' => __('Each color code is required when type is Color.'),
        ];
    ...
    protected static function updateValidation($data = [])
    {
        ...
        $messages = [
            'values.required' => __('At least 1 attribute value is required.'),
            'additional_values.required_if' => __('Each color code is required when type is Color.'),
        ];
    ...
    {
        return $this->hasMany('App\Models\VendorAttribute', 'attribute_id', 'id');
    }
}
