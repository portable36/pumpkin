...
class ProductSettingController extends Controller
{
    ...
    {
        $response = $this->storeData($request->only('show_sold_by', 'is_publish_product', 'is_vendor_customer_list_active', 'vendor_category', 'system_suggestion', 'vendor_cat_commission', 'access_system_category', 'is_vendor_shop_decoration_active', 'vendor_brand', 'vendor_attribute'), 'product_vendor');
    ...
    /**
     * Product filter setting
     *
     * @return \Illuminate\Contracts\View\View
     */
    public function filter(Request $request)
    {
        return $this->storeData($request->only(
            'filter_show_category',
            'filter_max_category_show',
            'filter_show_brand',
            'filter_max_brand_show',
            'filter_show_price_range',
            'filter_show_min_max_price',
            'filter_show_rating',
            'filter_show_attribute',
            'filter_max_attribute_show'
        ), 'product_filter');
    }
