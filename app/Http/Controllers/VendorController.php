...
class VendorController extends Controller
{
    ...
    {
        $data['roles'] = Role::getAll()->where('type', 'vendor')->whereNull('vendor_id')->where('slug', '!=', 'vendor-staff');
    ...
    public function store(StoreVendorRequest $request)
    {
        ...
        try {
            ...
            $vendor = Vendor::withTrashed()->whereEmailOrPhone($request->email, $request->phone)->first();
            $vendorId = $vendor?->id;
            if (! $vendor) {
