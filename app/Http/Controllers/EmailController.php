...
class EmailController extends Controller
{
    ...
    public function sendEmailWithAttachment($to, $subject, $messageBody, $invoiceName, $companyName = null)
    {
        ...
        $dataMail = [
            ...
            'subject' => $subject,
            'content' => $messageBody,
            'attach'  => \Storage::disk()->url("public/uploads/invoices/$invoiceName"),
        ];
    ...
    public function sendPhpEmail($to, $subject, $message, $emailInfo, $invoiceName)
    {
        ...
        if (! empty($invoiceName)) {
            return $mail->AddAttachment(\Storage::disk()->url('/public/uploads/invoices' . '/' . $invoiceName), 'Invoice', 'base64', 'application/pdf');
        }
