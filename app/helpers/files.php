...
if (! function_exists('getFileExtensions')) {
    ...
    function getFileExtensions($type = 0)
    {
        $extensions = [
            ...
            1 => ['jpg', 'jpeg', 'png', 'gif', 'webp', 'doc', 'docx', 'pdf'],
...
if (! function_exists('createDirectory')) {
    ...
    function createDirectory($path = '', $permission = null)
    {
        ...
        if (! isDirectoryExist($path)) {
            \Storage::disk()->makeDirectory($path, $permission, true);
        }

        // remove public from public/uploads due to regenerate upload folder in root directory
        return $path;
    }
}
...
if (! function_exists('printPDF')) {
    ...
    function printPDF($data, $filename, $template, $renderView, $type = null, $pdfVal = null)
    {
        ...
        if ($pdfVal == 'email') {
            ...
            // Store the PDF file using Laravel's filesystem
            return \Storage::disk()->put($filename, $pdfContent);
...
if (! function_exists('isFileExist')) {
     ...
     */
    function isFileExist(string $file): bool
    {
...
if (! function_exists('isDirectoryExist')) {
    /**
