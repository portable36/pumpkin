...
class EmailTemplatesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        if (version_compare(config('martvill.version'), '4.2.0', '<=')) {
...
<p style="margin-top: 32px; padding:0px 30px 0px 37px; font-family: \'DM Sans\', sans-serif; text-align: left; font-style: normal; font-weight: 500; font-size: 14px; line-height: 24px; color: #898989;">
    <span style="color: #2C2C2C;">Dear {user_name},</span> you have received a new confirmed order on 
    <span style="color:#0060A9; text-decoration:underline;"><a href="{company_url}" style="color:#0060A9 ; text-decoration:underline;">{company_name}</a></span> dated 
    <span style="color: #2C2C2C;">{order_confirm_date}.</span> 
    Please prepare the order for delivery. For assistance or additional details, log in to your account or contact us at 
    <span style="color: #2C2C2C;">{contact_number}.</span>
</p>
</td>
</tr>
</table>
...
&copy; 2022, {company_name}. All rights reserved.</p>
                ...
                'language_id' => 1,
                'status' => 'Active',
                'variables' => 'logo,order_number,user_name,shipping_item_name,shipping_provider_name,shipping_tracking_number,shipping_tracking_url,date_shipped,company_url,order_confirm_date,contact_number,currency_symbol,subtotal,shipping_charge,grand_total,shipping_address,payment_method,support_mail,company_name,tax_charge,discount_amount,track_code,products',
            ]);
        }
    }
}
